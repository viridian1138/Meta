...
class StringRec extends Meta<StringRec> {
     ...
     * kluge to support early versions of Apple MRJ (which had bugs).
     * @param index The index at which to store the character.
     * @param inChar The character to be stored.
     */
     ...
     * @return The contained character array.
     */
    ...
    /**
     * Deletes the node.  Note: unlike the original C++ version this does nothing.
     */
     ...
     * @param start_loc The start location
