...
/**
 * Callback is a base class that provides a framework to implement the "visit"
 * function often found both in data structure theory and practice. For
 * instance, the inorder traversal of a binary tree is often written in
 * textbooks with a visit() function to denote the visiting of each node.
 * Callback provides a way for {@link Meta}-compliant classes to implement such
 * a visit() function.
 * <P>
 * Here's an example. One has a class, which in this example will be called
 * RecClass, which contains a Meta-compliant binary tree. The goal is for an
 * object of RecClass to perform an inorder traversal on this binary tree with
 ...
 * 
 * @author Thorn Green
 * @param <T> The type of data in the callback.
 */
public class Callback<T extends Meta<T>> extends Object {

	/**
	 * Executes the callback.
	 * 
	 * @param in The object that generates the callback.
	 */
